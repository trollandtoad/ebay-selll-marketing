...
class ItemPriceMarkdown implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $promotion_image_url Required for MARKDOWN_SALE promotions, populate this field with a URL that points to an image to be used with the promotion. This image is displayed on the seller's All Offers page. The URL must point to either JPEG or PNG image and it must be a minimum of 500x500 pixels in dimension and cannot exceed 12Mb in size.
     *
     * @return self
     */
