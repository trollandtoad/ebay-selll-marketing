...
class ItemPromotionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets promotion_type
     *
     * @param string|null $promotion_type Indicates the type of the promotion, either MARKDOWN_SALE, ORDER_DISCOUNT, or VOLUME_DISCOUNT. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/sme:PromotionTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
