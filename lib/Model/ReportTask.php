...
class ReportTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets date_to
     *
     * @param string|null $date_to The date defining the end of the timespan covered by the report, in ISO 8601 UTC format. Promoted Listings reports are aggregated on a daily basis where each day begins and ends at midnight, Mountain Standard Time (MST).
     *
     * @return self
     */
